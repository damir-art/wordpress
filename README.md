...
## Разное
2021 - последняя тема на PHP, последующие уже на блоках.  
Одно из правил программирования, явное лучше неявного.

<p>
<a href="https://skalodrom16.ru">Куда пойти с ребёнком</a> - скалодром Эверест в городе Набережные Челны.</p>
